...
namespace Persistence.Migrations
{
    ...
    [Migration("20240325183427_bootcamp")]
    partial class bootcamp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd9d3481-6e06-404d-a9a3-a2c13c7ad17e"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 3, 25, 21, 34, 26, 256, DateTimeKind.Local).AddTicks(3576),
                            DateOfBirth = new DateTime(2024, 3, 25, 21, 34, 26, 256, DateTimeKind.Local).AddTicks(3558),
                            Email = "narch@kodlama.io",
                            FirstName = "arzu",
                            LastName = "alkan",
                            NationalIdentity = "1234567",
                            PasswordHash = new byte[] { 215, 77, 219, 150, 51, 242, 91, 60, 131, 226, 185, 153, 247, 105, 168, 248, 55, 127, 84, 149, 112, 1, 195, 108, 179, 154, 217, 88, 65, 154, 182, 145, 21, 141, 94, 201, 63, 116, 167, 11, 82, 142, 11, 190, 234, 182, 157, 125, 245, 14, 156, 31, 5, 251, 9, 249, 52, 110, 72, 73, 53, 213, 153, 126 },
                            PasswordSalt = new byte[] { 236, 238, 106, 203, 211, 27, 82, 165, 115, 47, 88, 90, 165, 139, 216, 147, 2, 171, 241, 194, 52, 114, 23, 80, 100, 13, 58, 90, 255, 151, 58, 126, 231, 18, 13, 240, 253, 177, 134, 53, 69, 141, 198, 38, 77, 196, 225, 187, 63, 181, 155, 100, 119, 128, 59, 125, 76, 72, 115, 78, 211, 255, 45, 59, 25, 124, 228, 57, 130, 73, 154, 95, 149, 112, 60, 102, 4, 81, 16, 176, 69, 174, 140, 155, 156, 41, 81, 51, 49, 67, 165, 107, 233, 110, 118, 128, 235, 119, 187, 81, 210, 208, 178, 93, 181, 245, 5, 12, 218, 24, 248, 105, 57, 253, 202, 122, 43, 138, 186, 147, 167, 117, 226, 200, 52, 144, 13, 196 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("973445a6-1501-46f0-90d6-d148a9288795"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("cd9d3481-6e06-404d-a9a3-a2c13c7ad17e")
                        });
                });
